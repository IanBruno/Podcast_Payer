    ...
    function initializeXML(url){
	   ...
	   if (!result.error){
		    ...
		    <audio id="audio" preload="auto" tabindex="0" controls="" type="audio/mpeg">
		        <source type="audio/m4a" src="http://www.archive.org/download/bolero_69/Bolero.mp3">
            ...
            */
			...
			img.setAttribute("class","img-rounded img-thumbnail");
	   		...
	   		var ulList= document.createElement("ul");
		   		ulList.setAttribute("id","playlist");
		   		ulList.setAttribute("class","list-group");


	   		var divNumber=document.createElement("div");
	   			divNumber.setAttribute("class","visible-lg");
	   		var ulNumber=document.createElement("ul");
	   			ulNumber.setAttribute("id","episodeNumber");
	   			ulNumber.setAttribute("class","list-group");


	   		var ulDuration=document.createElement("ul");
	   			ulDuration.setAttribute("id","Duration");
	   			ulDuration.setAttribute("class","list-group");

	   		var ulPubDate=document.createElement("ul");
	   			ulPubDate.setAttribute("id","PubDate");
	   			ulPubDate.setAttribute("class","list-group");
		    ...
		    for (var i = 0; i < items.length; i++) {
	            ...
	            var liList=document.createElement("li");
	            	liList.setAttribute("class","list-group-item");
		        ...
		        var liNumber=document.createElement("li");
		        	liNumber.setAttribute("class","list-group-item");
		        	liNumber.appendChild(document.createTextNode(i+1));
		        	ulNumber.appendChild(liNumber);

		        var liPubDate=document.createElement("li");
		        	liPubDate.setAttribute("class","list-group-item");
		        	date1 = new Date (item.getElementsByTagName('pubDate')[0].firstChild.nodeValue);
					dateP = date1.getDate();
					yearP = date1.getFullYear();
					monthP = date1.getMonth();

		        	liPubDate.appendChild(document.createTextNode(dateP +"-"+monthP+"-"+yearP));
		        	ulPubDate.appendChild(liPubDate);
		        ...
		        var liDuration=document.createElement("li");
		        	liDuration.setAttribute("class","list-group-item");
		        	liDuration.appendChild(document.createTextNode(nameSpaceDuration[0].firstChild.nodeValue));
		        	ulDuration.appendChild(liDuration);
            ...
            tdNumer.appendChild(divNumber);
            tdEpisode.appendChild(ulList);
            tdDuration.appendChild(ulDuration);
            tdPubDate.appendChild(ulPubDate);
